...
<body>
				...
				<ul class="nav navbar-nav navbar-right">
					<li>
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="{{ url('admin/skill/new') }}">+ Create a New Skill</a></li>
	...
	<div class="footer">
	 	<p></p>
		<p align="center">Il y a actuellement 1 visiteur(s) connecté(s)!</p>	<p align="center" class="text-muted">&copy; </p>
	 </div>
